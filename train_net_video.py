...
# MaskFormer
from ov2seg import add_ov2seg_config
from ov2seg import (
    YTVISDatasetMapper,
    YTVISEvaluator,
    OVISEvaluator,
...
class Trainer(DefaultTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        if "ovis" in dataset_name:
            return OVISEvaluator(dataset_name, cfg, True, output_folder)
        elif "ytvis" in dataset_name:
            return YTVISEvaluator(dataset_name, cfg, True, output_folder)
        elif "lvvis" in dataset_name:
            return LVVISEvaluator(dataset_name, cfg, True, output_folder)
        else:
