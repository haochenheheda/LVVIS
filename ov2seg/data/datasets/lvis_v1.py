...
_CUSTOM_SPLITS_LVIS = {
    ...
    "lvis_v1_train_norare_cloth": ("coco/", "lvis/lvis_v1_train_norare_cloth.json"),
    "lvis_v1_train_norare_coco": ("coco/", "lvis/lvis_v1_train_norare_coco.json"),
    "lvis_v1_train_norare_nocloth": ("coco/", "lvis/lvis_v1_train_norare_nocloth.json"),
    "lvis_v1_val_cloth": ("coco/", "lvis/lvis_v1_val_cloth.json"),
    "lvis_v1_val_person": ("coco/", "lvis/lvis_v1_val_person.json"),
    "lvis_v1_val_car": ("coco/", "lvis/lvis_v1_val_car.json"),
    "lvis_v1_val_coco": ("coco/", "lvis/lvis_v1_val_coco.json")
}
