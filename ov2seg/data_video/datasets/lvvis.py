...
from .lvvis_categories import LVVIS_CATEGORIES
"""
...
def load_lvvis_json(json_file, image_root, dataset_name=None, extra_annotation_keys=None):
...
def register_lvvis_instances(name, metadata, json_file, image_root):
    ...
    DatasetCatalog.register(name, lambda: load_lvvis_json(json_file, image_root, name))
